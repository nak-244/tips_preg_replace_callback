...
function AjaxConfDisp($formitem){
	...
	if($formitem['Err']>1)
		print '<div id="error" class="olpmail"><p><span class="error">入力エラーを修正してください。</span></p>';
	else
		print '<div class="olpmail confirmed"><p><span class="confirm">入力内容に間違いが無ければ、送信ボタンを押してください。</span></p>';
...
{
	$minetype = array("image/jpeg","image/pjpeg","image/x-png","image/png","image/gif","image/bmp","application/pdf","application/octet-stream","application/x-shockwave-flash","text/plain","application/x-zip","application/zip","application/x-zip-compressed","application/x-lha-compressed","application/mspowerpoint","application/x-compress","application/x-excel","application/excel","application/vnd.ms-excel","application/vnd.ms-powerpoint","application/x-msexcel","application/x-gzip","application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/msword");
	// $ext  = array(".gif",".png",".jpg",".bmp",".pdf",".swf",".txt",".xls",".doc",".ppt",".zip",".lzh",".tar.gz",".docx",".xlsx");
	$ext  = array(".pdf");
